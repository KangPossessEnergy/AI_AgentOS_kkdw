      ...
      void execution
        .then(async (result) => {
          ...
          const clarificationRequest = !isCompacting
            && config.skills.includes('grill-me')
          ...
          const approvalRequest = !isCompacting
            ? findApprovalRequest(finalResult.toolCalls)
            : undefined;
          if (approvalRequest) {
            ...
            const timeoutMs = (
              approvalRequest.timeoutSeconds
